...
@Configuration
@ComponentScans(value= {@ComponentScan("com.niit.OnlineCollaboration"),
						@ComponentScan("model"),  
...
public class HibernateConfig {
	...
	public static final String DATABASE_PASSWORD="Durai@4086";
	...
	public LocalSessionFactoryBean getSessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.niit.OnlineCollaboration");  
